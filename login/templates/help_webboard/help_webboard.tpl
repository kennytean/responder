...
<table cellSpacing="1" cellPadding="7" width="650" border="0" align="center" bgColor="#aaaaaa" >
...
<tr>
	<td align="left" valign="top" bgColor="#FFFFFF" colSpan="2">
		<a href="help_userguide.php">User Guide</a>&nbsp;|
		<a href="help_tutorials.php">Tutorials</a>&nbsp;|
		<a href="help_faq.php">Frequently Asked Questions</a>&nbsp;|
		<b>FREE web-board</b>&nbsp;|
		<a href="help_emailsupport.php">E-mail Support</a>&nbsp;|
		<a href="help_phonesupport.php">Phone Support</a>&nbsp;|
	</td>
</tr>
