...
<tr>
	<td align="left" valign="top" bgColor="#FFFFFF" colSpan="2">
		...
		<a href="newsletters.php"><b>Newsletters</b></a>&nbsp;|
...
<tr>
	<td align="left" valign="top" bgColor="#FFFFFF" colSpan="2">
		<b>Edit Newsletters</b>&nbsp;|
		<a href="newsletters_test.php">Test Newsletters</a>&nbsp;|
		<a href="newsletters_broadcast.php">Send Broadcast</a>
	</td>
</tr>

<form name="form_message_actions" action="do_on_newsletter.php" method="post">
<tr>
	<td align="left" valign="top" width="25%" rowspan="1" bgColor="#FFFFFF">
		<b>All your newsletters: </b><br><br>
		(select one to edit)
	</td>
...
<tr>
	<td bgColor="#FFFFFF" valign="top">
		<b>Available newsletter templates</b>
	</td>
	<td bgColor="white" valign="top">
		<table width="100%" border="0" cellPadding="3" cellSpacing="0">
		{NEWSLETTER_TEMPLATES_LIST}
		</table>
	</td>
</tr>
<tr>
	<td bgColor="#FFFFFF" valign="top">
		<b>Personalizing your newsletters</b>
	</td>
	<td bgColor="white">
		<br>
		<p>There are four pre-set merge words you may use in Body or Subject (see above) to personalize your newsletters.<br>
		<ul> 
		...
		You can also predefine unlimited variables and use them in your	messages and broadcasts as <B>[[pre_XXXXX]]</B>
		...
		Prior to using these personalized custom variables in your message you must collect the information from your prospects using the <a href="prospects_htmlform.php">HTML Form</a> in Prospects.
		</font>
	</td>
</tr>
