<tr>
	...
	<td bgColor="white" valign="top">
		...
		<tr>
			...
			<td>[ <a href="newsletters_edit.php?selected={SELECTED}&type=text">plain text</a> ] [ <b>html enhanced</b> ]</td>
		...
		<tr height="10"><td></td></tr>
		<tr>
			<td colspan="2"><input type="button" value="Update Newsletter" onClick="MakeSubmit();"></td>
		</tr>
		</table>
	</td>
</tr>
